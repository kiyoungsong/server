...
namespace IronUtilites
{
    ...
    public class LogManager
    {
        ...
        IronThread loggingThread;

        IronThread removeThread;

        public int LogSaveDay;
        
        public string LogFolder = "Log_IronAuto";
        ...
        LogManager()
        {
            ...
            loggingThread = new IronThread(QueueSaveLog, null);
            loggingThread.Interval = 1000;
            loggingThread.Start();

            removeThread = new IronThread(RemoveLog, null);
